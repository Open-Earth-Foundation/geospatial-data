# Heat Mechanism Type — Model Card

## Purpose

Dominant heat mechanism type per cell for NbS screening and typology recommendation.
...
- `transformation/nbs_screening/docs/heat_nbs_dataset_lens.md`
