# Landslide Mechanism Type — Model Card

## Purpose

Dominant landslide mechanism type per cell for NbS screening and typology recommendation.
...
- `transformation/nbs_screening/docs/landslide_nbs_dataset_lens.md`
