#!/usr/bin/env python3
"""Export MERIT Hydro HAND into landslide_hazard data/input/.

Example:
  python transformation/merit_hydro/extract_hand.py --site plymouth
  python transformation/merit_hydro/extract_hand.py --site plymouth --qa-only
"""
...
from qa_local import qa_hand  # noqa: E402
...
def run(
    ...
    *,
    ...
    export_paths_summary(cfg, ["hand"])
    if write_qa:
        qa_hand(out_path, cfg, display=str(display))
    return out_path
